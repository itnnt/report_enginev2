...
"java" -cp %QUARTZ_CP% %LOG4J_PROPS% -Xms1024m -Xmx2048m -XX:-UseGCOverheadLimit gvl.dom.report_engine.ReportExtractingTiedAgencyPerformanceSegmentReportCancelExcluded
cmd /k 